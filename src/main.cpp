...
static void hal_init(lv_color_t primary, lv_color_t secondary) {
    ...
    disp->driver->dpi = LV_DPI_DEF * disp->driver->hor_res / 480;  // LVGL defaults scale with the screen
    ...
    disp_drv.dpi      = LV_DPI_DEF * SDL_HOR_RES / 480;  // LVGL defaults scale with the screen
